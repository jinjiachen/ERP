...
class HeatTransferFrame(wx.Frame):
    def __init__(self):
        ...
        if self.singlebox2.GetSelection()==0:
            ...
            self.text13=wx.StaticText(self.panel,-1,'管板材料',(350,150))
            self.input13=wx.Choice(self.panel,-1,(500,150),choices=mat2)            
            self.text14=wx.StaticText(self.panel,-1,'管孔直径(mm)',(350,190))
            self.input14=wx.TextCtrl(self.panel,-1,'',(500,190))
            self.text15=wx.StaticText(self.panel,-1,'壳侧腐蚀余量(mm)',(350,230))
            self.input15=wx.TextCtrl(self.panel,-1,'',(500,230))                    
            self.text16=wx.StaticText(self.panel,-1,'管侧腐蚀余量(mm)',(350,270))
            self.input16=wx.TextCtrl(self.panel,-1,'',(500,270))
            self.text17=wx.StaticText(self.panel,-1,'壳侧结构开槽深度(mm)',(350,310))
            self.input17=wx.TextCtrl(self.panel,-1,'',(500,310))
            self.text18=wx.StaticText(self.panel,-1,'管侧分程隔板槽深度(mm)',(350,350))
            self.input18=wx.TextCtrl(self.panel,-1,'',(500,350))
            self.text19=wx.StaticText(self.panel,-1,'管板最小厚度(mm)',(350,390))
            self.input19=wx.TextCtrl(self.panel,-1,'',(500,390))
            self.text20=wx.StaticText(self.panel,-1,'管板与换热管连接形式',(350,430))
            self.input20=wx.Choice(self.panel,-1,(500,430),choices=type3)            
            self.text21=wx.StaticText(self.panel,-1,'一根管子支撑截面积(mm2)',(350,470))
            self.input21=wx.TextCtrl(self.panel,-1,'',(500,470))
            self.text22=wx.StaticText(self.panel,-1,'系数C(表20)',(350,510))
            self.input22=wx.TextCtrl(self.panel,-1,'',(500,510))
            self.text23=wx.StaticText(self.panel,-1,'有效焊接高度(mm)',(350,550))
            self.input23=wx.TextCtrl(self.panel,-1,'',(500,550))
            self.text2=wx.StaticText(self.panel,-1,'换热管材料',(350,590))
            self.input24=wx.Choice(self.panel,-1,(500,590),choices=mat3) 
            self.text25=wx.StaticText(self.panel,-1,'有效焊接高度(mm)',(350,630))
            self.input25=wx.TextCtrl(self.panel,-1,'',(500,630))
            self.text25=wx.StaticText(self.panel,-1,'换热管外径(mm)',(350,670))
            self.input25=wx.TextCtrl(self.panel,-1,'',(500,670))
            self.text25=wx.StaticText(self.panel,-1,'换热管壁厚(mm)',(350,710))
