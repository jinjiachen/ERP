...
class VolumeFrame(wx.Frame):
    def __init__(self):
        ...
        #创建初始界面
        self.text1=wx.StaticText(self.panel,-1,'设计压力(MPa)',(20,80))
        self.input1=wx.TextCtrl(self.panel,-1,'',(120,80))
        self.text2=wx.StaticText(self.panel,-1,'焊接系数',(20,120))
        self.input2=wx.TextCtrl(self.panel,-1,'',(120,120))
        self.text3=wx.StaticText(self.panel,-1,'选用应力(MPa)',(20,160))
        self.input3=wx.TextCtrl(self.panel,-1,'',(120,160))
        self.text4=wx.StaticText(self.panel,-1,'容器的容积(m^3)',(20,200))
        self.input4=wx.TextCtrl(self.panel,-1,'',(120,200))
        self.text5=wx.StaticText(self.panel,-1,'筒体的长度(mm)',(20,240))
        self.input5=wx.TextCtrl(self.panel,-1,'',(120,240))
        self.text6=wx.StaticText(self.panel,-1,'筒体的壁厚(mm)',(20,280))
        self.input6=wx.TextCtrl(self.panel,-1,'',(120,280))
        self.text7=wx.StaticText(self.panel,-1,'筒体的直径(mm)',(20,320))
        self.input7=wx.TextCtrl(self.panel,-1,'',(120,320))
        self.text8=wx.StaticText(self.panel,-1,'封头尺寸(mm)',(20,360))
